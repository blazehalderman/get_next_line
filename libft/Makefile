...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/09/18 20:46:58 by bhalderm          #+#    #+#              #
#    Updated: 2017/10/05 14:32:29 by bhalderm         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_lstdelone.c ft_lstdel.c ft_lstadd.c ft_lstiter.c ft_lstmap.c ft_charcount.c\
ft_ishidden.c ft_max.c ft_swap.c ft_wcount.c
...
ft_lstdelone.o ft_lstdel.o ft_lstadd.o ft_lstiter.o ft_lstmap.o ft_charcount.o\
ft_ishidden.o ft_max.o ft_swap.o ft_wcount.o
